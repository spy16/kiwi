...
// Open opens the Linear Hashing index file and creates an LHStore instance.
// If nil value is provided for options, defaultOptions are used.
func Open(indexFile string, blob BlobStore, opts *Options) (*Store, error) {
	if opts == nil {
		opts = &defaultOptions
	}
...
func (lhs *Store) bucketIndex(hash uint32) uint32 {
	return hash % lhs.bucketCount
}
